...
object AgentSkillBuilder {
    ...
    private fun inferFallback(toolName: String): String = when (toolName) {
        ...
        "remote_project_verify" -> "若验证失败，读取 stderr 修复后重试"
        ...
        "product_search" -> "若搜索无结果，更换关键词或平台后再试"
        "product_extract" -> "若无法提取，补充更清晰的商品原文"
